...
var SocialExpress = function(settings,callback) {
  ...
  expressApp.configure(function(){
    ...
    var viewsDir = settings.express.viewsDir;
    //var viewsDir = path.join(__dirname ,'..','..','web','views') || settings.express.viewsDir;
    console.log(viewsDir);
    expressApp.set('views', viewsDir);
    //expressApp.use('views', path.join(__dirname ,'..','..','web','views'));
    ...
    expressApp.use( function(req, res, next) {
      ...
      if (toobusy())  {
        ...
        logger.warn(busyMessage); //remove newline
